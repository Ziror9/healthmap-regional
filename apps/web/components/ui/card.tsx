...
/**
 * Superficie de conteudo. Borda, nunca sombra: sombra em todo bloco achata a
 * hierarquia (todo elemento passa a gritar "sou um objeto separado"). A
 * elevacao fica reservada ao que flutua de verdade - menu, drawer, tooltip.
 */
